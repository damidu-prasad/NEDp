 ...
 */
@ManagedBean(name = "dataInputScore1")
@ViewScoped
public class DataInputScore1 {
...
//                        if (termList.size() > 0) {
//                            yearList.add(new YearList(sc.getYear_name(), termList));
//                        }
                    }
                    ...
                    sc_list.add(new SchoolNameList(0, v.getId(), v.getGeneralOrganizationProfileId().getName(), comlib.getDouble(val), val, listAS.size() + "", loggedCount + "", comlib.getDouble(logg_perc)));
                    k++;
                }
