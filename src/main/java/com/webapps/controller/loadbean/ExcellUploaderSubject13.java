...
@ManagedBean
@ViewScoped
public class ExcellUploaderSubject13 {
    ...
    public void initial() {
        ...
        fpath = "E:\\Colombo-Office\\NEDP_Files\\SWRDBandaranayake_Vidyalaya\\Gr_10_11.xlsx";
            ...
            while (rowIterator.hasNext()) {
                ...
                if (row.getRowNum() > 4) {
                    ...
                    while (cellIterator.hasNext()) {
                        ...
                        cell.getColumnIndex();
                        if (row.getRowNum() == 5) {
                            if (cell.getColumnIndex() > 1 && cell.getColumnIndex() <= 13) {
...
//}
    ...
    public synchronized void saveMarks(String name, String sub0, String sub1, String sub2, String sub3, String sub4, String sub5, String sub6, String sub7, String sub8, String sub9, String sub10, String sub11, String sub12) {
        ...
        boolean is_present6 = true;
        if (sub6.equals("") || sub6.equals("-")) {
            marks6 = 0.0;
            is_mandatory6 = false;
            is_present6 = true;
        } else if (sub6.equals("ab")) {
            marks6 = 0.0;
            is_mandatory6 = true;
            is_present6 = false;
        } else {
        ...
        boolean is_present7 = true;
        if (sub7.equals("") || sub7.equals("-")) {
            marks7 = 0.0;
            is_mandatory7 = false;
            is_present7 = true;
        } else if (sub7.equals("ab")) {
            marks7 = 0.0;
            is_mandatory7 = true;
            is_present7 = false;
        } else {
        ...
        boolean is_present8 = true;
        if (sub8.equals("") || sub8.equals("-")) {
            marks8 = 0.0;
            is_mandatory8 = false;
            is_present8 = true;
        } else if (sub8.equals("ab")) {
            marks8 = 0.0;
            is_mandatory8 = true;
            is_present8 = false;
        } else {
        ...
        boolean is_present9 = true;
        if (sub9.equals("") || sub9.equals("-")) {
            marks9 = 0.0;
            is_mandatory9 = false;
            is_present9 = true;
        } else if (sub9.equals("ab")) {
            marks9 = 0.0;
            is_mandatory9 = true;
            is_present9 = false;
        } else {
        ...
        boolean is_present10 = true;
        if (sub10.equals("") || sub10.equals("-")) {
            marks10 = 0.0;
            is_mandatory10 = false;
            is_present10 = true;
        } else if (sub10.equals("ab")) {
            marks10 = 0.0;
            is_mandatory10 = true;
            is_present10 = false;
        } else {
        ...
        if (sm_list10.size() > 0) {
            ...
            sm10.setIsPresent(is_present10);
            uni.update(sm10);
        } else {
        ...
        boolean is_present11 = true;
        if (sub11.equals("") || sub11.equals("-")) {
            marks11 = 0.0;
            is_mandatory11 = false;
            is_present11 = true;
        } else if (sub11.equals("ab")) {
            marks11 = 0.0;
            is_mandatory11 = true;
            is_present11 = false;
        } else {
        ...
        if (sm_list11.size() > 0) {
            ...
            sm11.setIsPresent(is_present11);
            uni.update(sm11);
        } else {
...
//        boolean is_present12 = true;
//        if (sub12.equals("") || sub12.equals("-")) {
//            marks12 = 0.0;
//            is_mandatory12 = false;
//            is_present12 = true;
//        } else if (sub12.equals("ab")) {
//            marks12 = 0.0;
//            is_mandatory12 = true;
//            is_present12 = false;
//        } else {
...
//            sm12.setIsPresent(is_present12);
//            uni.update(sm12);
//        } else {
