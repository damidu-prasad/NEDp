...
import com.webapps.controller.managebeans.TeacherPerformanceAnalyzerOld;
 ...
 */
public class SortArraysTeacherPerformanceAnalyzerOld {

    static final Comparator<TeacherPerformanceAnalyzerOld.MeanTeacherList> ORDER_BY_MEAN = new Comparator<TeacherPerformanceAnalyzerOld.MeanTeacherList>() {

        @Override
        public int compare(TeacherPerformanceAnalyzerOld.MeanTeacherList o1, TeacherPerformanceAnalyzerOld.MeanTeacherList o2) {
            return Double.compare(o1.getTeachermean(), o2.getTeachermean());
        }
    };

    static final Comparator<TeacherPerformanceAnalyzerOld.MeanTeacherList> ORDER_BY_RULES = new Comparator<TeacherPerformanceAnalyzerOld.MeanTeacherList>() {
    ...
    public static TeacherPerformanceAnalyzerOld.MeanTeacherList[] GetArray(TeacherPerformanceAnalyzerOld.MeanTeacherList[] addressArray) {
